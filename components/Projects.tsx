...
function Projects({ projects }: Props) {
    return (
     <motion.div className="h-fit min-h-screen relative flex flex-col overflow-hidden lg:overflow-auto text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0"
     initial={{ opacity: 0 }}
     transition={{duration: 1.5}}
     whileInView={{ opacity: 1 }} >
        <h3 className="absolute top-0 uppercase tracking-[15px] text-gray-500 text-2xl">
            Projects</h3>
         <div className='absolute w-full lg:mx-h-98/100 flex lg:overflow-x-scroll scrollbar scrollbar-thumb-green-500 snap-x snap-mandatory z-20 top-24'>
