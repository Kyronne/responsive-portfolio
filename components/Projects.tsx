...
function Projects({ projects }: Props) {
    return (
     <motion.div className="h-fit relative lg:max-h-screen flex flex-col overflow-auto text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0"
     initial={{ opacity: 0 }}
