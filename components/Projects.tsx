...
function Projects({ projects }: Props) {
    return (
     <motion.div className="h-fit min-h-screen relative lg:max-h-screen flex flex-col overflow-hidden  text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0"
     initial={{ opacity: 0 }}
