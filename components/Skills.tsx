...
function Skills({ skills }: Props) {
  return (
    ...
    h-fit min-h-screen overflow-y-auto overflow-x-hidden justify-center mx-auto xl:space-y-0 items-center">
        ...
        <div className="top-24 grid grid-cols-3 gap-1 max-w-screen" >
