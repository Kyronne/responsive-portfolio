...
function Skills({ skills }: Props) {
  return (
    ...
    h-auto min-h-screen overflow-hidden justify-center mx-auto xl:space-y-0 items-center">
        ...
        <div className="absolute overflow-auto scrollbar scrollbar-thumb-green-500 top-24 grid grid-cols-2 lg:grid-cols-3 gap-1 max-w-screen" >
