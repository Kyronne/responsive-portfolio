...
function About({ pageInfo }: Props) {
  return (
    ...
    className="flex flex-col relative h-fit min-h-screen overflow-auto text-center md:text-left md:flex-row max-w-full lg:w-2/3 px-10 justify-evenly mx-auto items-center">
