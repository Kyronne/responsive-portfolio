...
function WorkExperience({ experiences }: Props) {
  return (
    <motion.div
     ...
     className="h-fit flex relative overflow-auto flex-col text-left md:flex-row max-w-full px-10 justify-evenly lg:justify-center lg:content-center mx-auto items-center">
